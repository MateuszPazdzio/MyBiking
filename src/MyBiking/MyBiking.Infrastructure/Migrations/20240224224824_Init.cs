    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WheelieRides", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WheelieRides_Rides_RideId",
                        column: x => x.RideId,
                        principalTable: "Rides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WheelePoint_Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Altitude = table.Column<double>(type: "float", nullable: false),
                    WheelieRideId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WheelieItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WheelieItems_WheelieRides_WheelieRideId",
                        column: x => x.WheelieRideId,
                        principalTable: "WheelieRides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WheelieItems_WheelieRideId",
                table: "WheelieItems",
                column: "WheelieRideId");

            migrationBuilder.CreateIndex(
                name: "IX_WheelieRides_RideId",
                table: "WheelieRides",
                column: "RideId");
        }
